...
VALUES(1, 'neema', 'patelneema93@gmail.com', '$2a$10$FB');
INSERT INTO users (id, name, email, password)
VALUES(2, 'Eva Stanley', 'sebastianguerra@ymail.com', '$2a$10$FB');
INSERT INTO users (id, name, email, password)
VALUES(3, 'Louisa Meyer', 'jacksonrose@hotmail.com', '$2a$10$FB');
INSERT INTO users (id, name, email, password)
VALUES(4, 'Dominic Parks', 'victoriablackwell@outlook.com', '$2a$10$FB');
INSERT INTO users (id, name, email, password)
VALUES(5, 'Sue Luna', 'jasonvincent@gmx.com', '$2a$10$FB');
INSERT INTO users (id, name, email, password)
VALUES(6, 'Rosalie Garza', 'jacksondavid@gmx.com', '$2a$10$FB');
INSERT INTO users (id, name, email, password)
VALUES(7, 'Etta West', 'charlielevy@yahoo.com', '$2a$10$FB');
INSERT INTO users (id, name, email, password)
VALUES(8, 'Margaret Wong', 'makaylaweiss@icloud.com', '$2a$10$FB');
INSERT INTO users (id, name, email, password)
VALUES(9, 'Leroy Hart', 'jaycereynolds@inbox.com', '$2a$10$FB');
